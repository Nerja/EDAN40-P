...
-- | Sequentially applies the given parser the given amount of times
-- from the pdf
iteratePars :: Parser a -> Int -> Parser [a]
iteratePars m 0 = return []
iteratePars m i = m # iteratePars m (i-1) >-> cons
