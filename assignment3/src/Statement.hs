...
parseAssignment = word #- accept ":=" # Expr.parse #- require ";" >-> uncurry Assignment
...
parseIf = accept "if" -# Expr.parse #- require "then" # parse #- require "else" # parse >-> (uncurry . uncurry) If

parseWhile = accept "while" -# Expr.parse #- require "do" # parse >-> uncurry While

parseBeginEnd = accept "begin" -# iter parse #- require "end" >-> Statements
...
instance Parse Statement where
  parse = parseAssignment ! parseSkip ! parseRead ! parseWrite ! parseIf ! parseWhile ! parseBeginEnd ! parseComment
  toString = stringify ""
